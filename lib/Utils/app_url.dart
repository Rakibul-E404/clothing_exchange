class AppUrl {
  ...
  static String baseUrl = 'https://api.bearemountclothing.co.uk/api/v1';
  // static String imageBaseUrl = 'https://d7001.sobhoy.com/';
  static String imageBaseUrl = 'https://api.bearemountclothing.co.uk/';
  ...
  static String report = '$baseUrl/users/delete_account';
