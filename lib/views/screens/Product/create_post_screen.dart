...
class _CreatePostPageState extends State<CreatePostPage> {
  ...
  // New _pickImage method copied and adapted from PersonalInformationScreen
  ...
  Future<void> _submitPost() async {
    ...
    // Optional: Image validation (file size, type)
    try {
    ...
    try {
      ...
      /// TODO : Fix the syntax of the age and the size ==== >
      request.fields['age'] = _ageRange ?? '';
      // request.fields['age'] = '0-1';
